...
export const aboutMePills: AboutMePill[] = [
    {
        ...
        tooltip:
            "See patterns, simplify complexity, and generate creative solutions while building trust through actively listening and collaborating",
    },
    ...
    {
        label: "& more...",
        tooltip: "under construction: stay tuned to find out!",
    },
];
