...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    (el: HTMLElement) => {
      ...
      refDiv.setAttribute("data-item-reference", "true");
    ...
    <>
      ...
      >
        <main ref={mainRef} className={styles["sphere-main"]}>
          ...
          <div className={`${styles.overlay} ${styles["overlay--blur"]}`} />
          <div className={`${styles["edge-fade"]} ${styles["edge-fade--top"]}`} />
          <div className={`${styles["edge-fade"]} ${styles["edge-fade--bottom"]}`} />
